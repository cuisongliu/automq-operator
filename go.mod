module github.com/cuisongliu/automq-operator
...
require (
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.72.1-0.20240329203515-2e75484c3174
	k8s.io/api v0.29.3
